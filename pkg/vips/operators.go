 ...
 *
 * Generated at 05:13PM on February 01, 2020
 */
...
// Unsupported: case: 'VipsArrayImage'
...
// Unsupported: jpegload_source: 'VipsSource'
// Unsupported: jpegsave_buffer: 'VipsBlob'
// Unsupported: jpegsave_target: 'VipsTarget'
// Unsupported: magickload_buffer: 'VipsBlob'
// Unsupported: magicksave_buffer: 'VipsBlob'
// Unsupported: pdfload_buffer: 'VipsBlob'
// Unsupported: pngload_buffer: 'VipsBlob'
// Unsupported: pngload_source: 'VipsSource'
// Unsupported: pngsave_buffer: 'VipsBlob'
// Unsupported: pngsave_target: 'VipsTarget'
// Unsupported: profile_load: 'VipsBlob'
// Unsupported: radload_buffer: 'VipsBlob'
// Unsupported: radload_source: 'VipsSource'
// Unsupported: radsave_buffer: 'VipsBlob'
// Unsupported: radsave_target: 'VipsTarget'
// Unsupported: sum: 'VipsArrayImage'
// Unsupported: svgload_buffer: 'VipsBlob'
// Unsupported: svgload_source: 'VipsSource'
// Unsupported: switch: 'VipsArrayImage'
// Unsupported: thumbnail_buffer: 'VipsBlob'
// Unsupported: thumbnail_source: 'VipsSource'
// Unsupported: tiffload_buffer: 'VipsBlob'
// Unsupported: tiffload_source: 'VipsSource'
// Unsupported: tiffsave_buffer: 'VipsBlob'
// Unsupported: webpload_buffer: 'VipsBlob'
// Unsupported: webpload_source: 'VipsSource'
// Unsupported: webpsave_buffer: 'VipsBlob'
// Unsupported: webpsave_target: 'VipsTarget'
...
// Affine executes the 'affine' operation
func Affine(in *C.VipsImage, matrix DoubleArray, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
		InputDoubleArray("matrix", matrix),
		OutputImage("out", &out),
	)
	incOpCounter("affine")
	err = vipsCall("affine", options)
	return out, err
}

// Affine executes the 'affine' operation
func (in *ImageRef) Affine(matrix DoubleArray, options ...*Option) error {
	out, err := Affine(in.image, matrix, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// BandjoinConst executes the 'bandjoin_const' operation
func BandjoinConst(in *C.VipsImage, c DoubleArray, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
		InputDoubleArray("c", c),
		OutputImage("out", &out),
	)
	incOpCounter("bandjoin_const")
	err = vipsCall("bandjoin_const", options)
	return out, err
}

// BandjoinConst executes the 'bandjoin_const' operation
func (in *ImageRef) BandjoinConst(c DoubleArray, options ...*Option) error {
	out, err := BandjoinConst(in.image, c, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// BooleanConst executes the 'boolean_const' operation
func BooleanConst(in *C.VipsImage, boolean OperationBoolean, c DoubleArray, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	err = vipsCall("boolean_const", options)
	return out, err
}

// BooleanConst executes the 'boolean_const' operation
func (in *ImageRef) BooleanConst(boolean OperationBoolean, c DoubleArray, options ...*Option) error {
	out, err := BooleanConst(in.image, boolean, c, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// Canny executes the 'canny' operation
func Canny(in *C.VipsImage, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	incOpCounter("canny")
	err = vipsCall("canny", options)
	return out, err
}

// Canny executes the 'canny' operation
func (in *ImageRef) Canny(options ...*Option) error {
	out, err := Canny(in.image, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// Cmyk2Xyz executes the 'CMYK2XYZ' operation
func Cmyk2Xyz(in *C.VipsImage, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	err = vipsCall("CMYK2XYZ", options)
	return out, err
}

// Cmyk2Xyz executes the 'CMYK2XYZ' operation
func (in *ImageRef) Cmyk2Xyz(options ...*Option) error {
	out, err := Cmyk2Xyz(in.image, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// DrawCircle executes the 'draw_circle' operation
func DrawCircle(image *C.VipsImage, ink DoubleArray, cx int, cy int, radius int, options ...*Option) error {
	var err error
	options = append(options,
		InputImage("image", image),
		InputDoubleArray("ink", ink),
		InputInt("cx", cx),
		InputInt("cy", cy),
		InputInt("radius", radius),
	)
	incOpCounter("draw_circle")
	err = vipsCall("draw_circle", options)
	return err
}

// DrawFlood executes the 'draw_flood' operation
func DrawFlood(image *C.VipsImage, ink DoubleArray, x int, y int, options ...*Option) error {
	var err error
	options = append(options,
		InputImage("image", image),
		InputDoubleArray("ink", ink),
	...
	incOpCounter("draw_flood")
	err = vipsCall("draw_flood", options)
	return err
}
...
// DrawLine executes the 'draw_line' operation
func DrawLine(image *C.VipsImage, ink DoubleArray, x1 int, y1 int, x2 int, y2 int, options ...*Option) error {
	var err error
	options = append(options,
		InputImage("image", image),
		InputDoubleArray("ink", ink),
	...
	err = vipsCall("draw_line", options)
	return err
}

// DrawMask executes the 'draw_mask' operation
func DrawMask(image *C.VipsImage, ink DoubleArray, mask *C.VipsImage, x int, y int, options ...*Option) error {
	var err error
	options = append(options,
		InputImage("image", image),
		InputDoubleArray("ink", ink),
	...
	err = vipsCall("draw_mask", options)
	return err
}

// DrawRect executes the 'draw_rect' operation
func DrawRect(image *C.VipsImage, ink DoubleArray, left int, top int, width int, height int, options ...*Option) error {
	var err error
	options = append(options,
		InputImage("image", image),
		InputDoubleArray("ink", ink),
	...
	err = vipsCall("draw_rect", options)
	return err
}
...
// Fitsload executes the 'fitsload' operation
func Fitsload(filename string, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputString("filename", filename),
	...
	incOpCounter("fitsload")
	err = vipsCall("fitsload", options)
	return out, err
}

// Fitssave executes the 'fitssave' operation
func Fitssave(in *C.VipsImage, filename string, options ...*Option) error {
	var err error
	options = append(options,
		InputImage("in", in),
		InputString("filename", filename),
	)
	incOpCounter("fitssave")
	err = vipsCall("fitssave", options)
	return err
}
...
// Getpoint executes the 'getpoint' operation
func Getpoint(in *C.VipsImage, x int, y int, options ...*Option) (DoubleArray, error) {
	var outArray DoubleArray
	var err error
	options = append(options,
		InputImage("in", in),
		InputInt("x", x),
		InputInt("y", y),
		OutputDoubleArray("out-array", &outArray),
	)
	incOpCounter("getpoint")
	err = vipsCall("getpoint", options)
	return outArray, err
}
...
// Linear executes the 'linear' operation
func Linear(in *C.VipsImage, a DoubleArray, b DoubleArray, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
		InputDoubleArray("a", a),
		InputDoubleArray("b", b),
		OutputImage("out", &out),
	)
	incOpCounter("linear")
	err = vipsCall("linear", options)
	return out, err
}

// Linear executes the 'linear' operation
func (in *ImageRef) Linear(a DoubleArray, b DoubleArray, options ...*Option) error {
	out, err := Linear(in.image, a, b, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// Magicksave executes the 'magicksave' operation
func Magicksave(in *C.VipsImage, filename string, options ...*Option) error {
	var err error
	options = append(options,
		InputImage("in", in),
		InputString("filename", filename),
	)
	incOpCounter("magicksave")
	err = vipsCall("magicksave", options)
	return err
}
...
// Math2Const executes the 'math2_const' operation
func Math2Const(in *C.VipsImage, math2 OperationMath2, c DoubleArray, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	err = vipsCall("math2_const", options)
	return out, err
}

// Math2Const executes the 'math2_const' operation
func (in *ImageRef) Math2Const(math2 OperationMath2, c DoubleArray, options ...*Option) error {
	out, err := Math2Const(in.image, math2, c, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// Matload executes the 'matload' operation
func Matload(filename string, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputString("filename", filename),
	...
	incOpCounter("matload")
	err = vipsCall("matload", options)
	return out, err
}
...
// Openexrload executes the 'openexrload' operation
func Openexrload(filename string, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputString("filename", filename),
	...
	incOpCounter("openexrload")
	err = vipsCall("openexrload", options)
	return out, err
}

// Openslideload executes the 'openslideload' operation
func Openslideload(filename string, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputString("filename", filename),
	...
	incOpCounter("openslideload")
	err = vipsCall("openslideload", options)
	return out, err
}
...
// RelationalConst executes the 'relational_const' operation
func RelationalConst(in *C.VipsImage, relational OperationRelational, c DoubleArray, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	err = vipsCall("relational_const", options)
	return out, err
}

// RelationalConst executes the 'relational_const' operation
func (in *ImageRef) RelationalConst(relational OperationRelational, c DoubleArray, options ...*Option) error {
	out, err := RelationalConst(in.image, relational, c, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// RemainderConst executes the 'remainder_const' operation
func RemainderConst(in *C.VipsImage, c DoubleArray, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	err = vipsCall("remainder_const", options)
	return out, err
}

// RemainderConst executes the 'remainder_const' operation
func (in *ImageRef) RemainderConst(c DoubleArray, options ...*Option) error {
	out, err := RemainderConst(in.image, c, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// Rotate executes the 'rotate' operation
func Rotate(in *C.VipsImage, angle float64, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
		InputDouble("angle", angle),
		OutputImage("out", &out),
	)
	incOpCounter("rotate")
	err = vipsCall("rotate", options)
	return out, err
}

// Rotate executes the 'rotate' operation
func (in *ImageRef) Rotate(angle float64, options ...*Option) error {
	out, err := Rotate(in.image, angle, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// Sobel executes the 'sobel' operation
func Sobel(in *C.VipsImage, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	incOpCounter("sobel")
	err = vipsCall("sobel", options)
	return out, err
}

// Sobel executes the 'sobel' operation
func (in *ImageRef) Sobel(options ...*Option) error {
	out, err := Sobel(in.image, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// Transpose3D executes the 'transpose3d' operation
func Transpose3D(in *C.VipsImage, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	err = vipsCall("transpose3d", options)
	return out, err
}

// Transpose3D executes the 'transpose3d' operation
func (in *ImageRef) Transpose3D(options ...*Option) error {
	out, err := Transpose3D(in.image, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
...
// Xyz2Cmyk executes the 'XYZ2CMYK' operation
func Xyz2Cmyk(in *C.VipsImage, options ...*Option) (*C.VipsImage, error) {
	var out *C.VipsImage
	var err error
	options = append(options,
		InputImage("in", in),
	...
	err = vipsCall("XYZ2CMYK", options)
	return out, err
}

// Xyz2Cmyk executes the 'XYZ2CMYK' operation
func (in *ImageRef) Xyz2Cmyk(options ...*Option) error {
	out, err := Xyz2Cmyk(in.image, options...)
	if err != nil {
		return err
	}
	in.SetImage(out)
